...
<h1 class="text-center" style="color:white;">Eurasia Decor</h1>
<div class="row">

<div class="col-lg-6">
<h2 class="text-center" style="color:white;">Please Login</h2>
...
<div class="col-lg-6">
<h2 class="text-center" style="color:white;">Create an Account</h2>
